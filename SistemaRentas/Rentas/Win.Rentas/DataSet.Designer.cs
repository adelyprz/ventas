...
namespace Win.Rentas {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, byte[] Foto, double Precio, int Existencia, CategoriaRow parentCategoriaRowByCategoria_Producto, TipoRow parentTipoRowByTipo_Producto, bool Activo) {
...
namespace Win.Rentas.DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [Foto], [Precio], [Existencia], [CategoriaId], [TipoId], [Activo]) VALUES (@Descripcion, @Foto, @Precio, @Existencia, @CategoriaId, @TipoId, @Activo);
SELECT Id, Descripcion, Foto, Precio, Existencia, CategoriaId, TipoId, Activo FROM Producto WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [Foto] = @Foto, [Precio] = @Precio, [Existencia] = @Existencia, [CategoriaId] = @CategoriaId, [TipoId] = @TipoId, [Activo] = @Activo WHERE (([Id] = @Original_Id) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_TipoId) AND ([Activo] = @Original_Activo));
SELECT Id, Descripcion, Foto, Precio, Existencia, CategoriaId, TipoId, Activo FROM Producto WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Descripcion, Foto, Precio, Existencia, CategoriaId, TipoId, Activo FRO" +
                "M dbo.Producto";
        ...
        public virtual int Insert(string Descripcion, byte[] Foto, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, byte[] Foto, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, int Original_Id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, int Original_TipoId, bool Original_Activo, int Id) {
            if ((Descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, byte[] Foto, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, int Original_Id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, int Original_TipoId, bool Original_Activo) {
            return this.Update(Descripcion, Foto, Precio, Existencia, CategoriaId, TipoId, Activo, Original_Id, Original_Precio, Original_Existencia, Original_CategoriaId, Original_TipoId, Original_Activo, Original_Id);
        }
    }
